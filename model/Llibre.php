...
/**
    ...
    public function buscarLlibrePerId(){
        $llibre = $this->db->query("SELECT t1.id, t1.titol, t1.portada_url, t1.mitja_vots, t1.cops_votat, t2.nom_i_cognoms, t1.data_alta, t3.nom_cat, t1.sinopsis, t1.contingut_url
